...
function fmtMonto(n) {
  ...
  const valor = convertirParaMostrar(n, STATE.empresaConfig?.moneda);
  return `${sym} ${Number(valor||0).toLocaleString('es-NI',{minimumFractionDigits:2,maximumFractionDigits:2})}`;
}
